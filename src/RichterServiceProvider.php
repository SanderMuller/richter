...
use Override;
use SanderMuller\Richter\Console\AffectedTestsCommand;
...
final class RichterServiceProvider extends PackageServiceProvider
{
    ...
    public function configurePackage(Package $package): void
    {
        $package
            ->name('richter')
            ->hasConfigFile()
            ->hasCommands(ImpactCommand::class, TraceCommand::class, DetectChangesCommand::class, AffectedTestsCommand::class, BenchmarkCommand::class, BenchmarkAddCommand::class, InternalTracerBranchCommand::class);
    }
