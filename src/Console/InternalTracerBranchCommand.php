...
/**
 * Internal worker for the parallel graph build (plan 050): runs {@see CodeGraphBuilder::buildTracerBranch()}
...
final class InternalTracerBranchCommand extends Command
{
    ...
    /** @var string */
    protected $description = "Internal: build richter's tracer branch in a child process (plan 050). Not for direct use.";
